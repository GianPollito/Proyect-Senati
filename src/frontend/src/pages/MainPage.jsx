...
        
    return (
            // AQUI SE REALIZA LA MODIFICACIÓN: mb-10 ha sido cambiado a mb-5
...
const FreeFireDiscountCard = () => {
    const NEON_COLOR = '#FF0000'; 
    const HOVER_BG_COLOR = '#8b000017'; // Rojo oscuro para el hover

    return (
        <>
            {/* INICIO DE CÓDIGO CSS PARA SOLUCIONAR EL HOVER */}
            <style jsx="true">{`
                @keyframes float {
                ...
                /* CLASE DEFINITIVA PARA EL HOVER DEL BOTÓN */
                .guardar-button-ff:hover {
                    /* Usamos !important para asegurar que sobrescriba el estilo inline de fondo: transparent */
                    background-color: ${HOVER_BG_COLOR} !important; 
                    /* Reducimos la sombra para dar efecto de "pulsado" */
                    box-shadow: 0 0 5px ${NEON_COLOR}, inset 0 0 2px ${NEON_COLOR} !important;
                }
            `}</style>
            {/* FIN DE CÓDIGO CSS PARA SOLUCIONAR EL HOVER */}
                    ...
                    <div className="col-span-2 space-y-3 pr-4">
                        ...
                        <button 
                            className={`px-6 py-2 mt-4 text-sm font-semibold rounded-lg transition duration-200 
                                        border-2 text-white
                                        guardar-button-ff`} // <--- CLASE APLICADA
                            style={{ 
