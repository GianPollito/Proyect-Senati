  ...
  function FeedbackModal({ isOpen, onClose }) {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 md:p-8 z-50">
        <div className="relative bg-[#1F2123] text-white rounded-xl shadow-2xl w-full max-w-md">
          
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-bold">Envíanos tus comentarios</h2>
          ...
          <div className="p-4">
            ...
            <textarea
              className="w-full h-28 bg-[#282a2c] text-white p-3 rounded-lg border border-gray-600 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none resize-none"
          ...
          <div className="p-4 border-t border-gray-700 flex justify-end space-x-4">
            <button
              onClick={onClose}
              className="px-5 py-1.5 rounded-lg text-gray-300 hover:bg-gray-700 transition duration-150"
            >
              Cancelar
            </button>
            <button
